  ...
  return (
    <footer className="bg-black pt-24 pb-8 px-8 md:px-16 border-t border-neutral-900">
      <div className="grid md:grid-cols-[2fr_1fr] gap-16 border-b border-neutral-900 pb-16">
        <div>
          <h3 className=" tracking-[0.15em] text-white mb-4">
            A.K.
          ...
          <p className="text-theme-text bg-clip-text leading-relaxed max-w-sm font-light">
            Experimental Condensed Matter Physicist
          </p>
        </div>
        <div className="flex flex-col md:flex-row  font-body gap-12 md:gap-24">
          <div>
            <h5 className="bg-heading-gradient text-transparent bg-clip-text uppercase tracking-widest mb-6">
              Directory
            </h5>
          ...
          <div>
            <h5 className="bg-heading-gradient text-transparent font bg-clip-text uppercase tracking-widest mb-6">
              Connect
            </h5>
            <div className="flex flex-col gap-4">
      ...
      <div className="pt-8 flex flex-col md:flex-row justify-between items-center text-neutral-600 text-xs tracking-wider">
        <p>
          ...
          . Crafted for Scientific Excellence.
        </p>
      </div>
    </footer>
  );
